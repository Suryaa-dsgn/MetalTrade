...
/*
  Source → Aggregator → Logistics → Buyer (Design System §15.1). Legible without
...
const stages: Stage[] = [
  {
    n: "01",
    title: "Source",
    detail: "Material sourced from mines, refiners, processors, and traders.",
    Icon: SourceIcon,
  },
  {
    n: "02",
    title: "Aggregator",
    detail: "Counterparty vetting, review, inspection, and documentation.",
    Icon: ProcessIcon,
  },
  {
    n: "03",
    title: "Logistics",
    detail: "Freight and origin customs coordinated; destination customs is the buyer's.",
    Icon: ContainerIcon,
  },
  {
    n: "04",
    title: "Buyer",
    detail: "Vetted corporate and institutional demand.",
